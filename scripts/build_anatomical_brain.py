...
def fetch_source() -> str:
    if os.path.exists(CACHE_FILE):
        with open(CACHE_FILE, encoding="utf-8") as f:
            return f.read()
    req = urllib.request.Request(SOURCE_URL, headers={"User-Agent": "HardikReadme/1.0"})
...
<!--
  ...
  recolored + composed by Hardik Dhamija's profile-build pipeline.
...
<svg xmlns="http://www.w3.org/2000/svg" width="1400" height="900" viewBox="0 0 1400 900" role="img" aria-label="Neural Skill Atlas">
  ...
  <text x="700" y="86" class="t-display" text-anchor="middle">Hardik's Skill Brain</text>
